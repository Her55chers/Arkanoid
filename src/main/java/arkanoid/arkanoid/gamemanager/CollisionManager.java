package arkanoid.arkanoid.gamemanager;

import javafx.geometry.Point2D;
import javafx.scene.layout.Pane;
import java.util.List;
import arkanoid.arkanoid.gameconfig.GameConfig;
import arkanoid.arkanoid.gameobject.*;
...
public class CollisionManager {
    ...
    public void handleBrickBallCollision(Ball ball, Brick brick, arkanoid.arkanoid.userinterface.UserInterface ui) {
